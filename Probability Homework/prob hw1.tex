...
\begin{homeworkProblem}%2
    ...
    \[
        \begin{split}
            ...
            &\text{There are 13*12*11 choices of value for no repeated value of the other 2 cards.}\\
            &\text{In this situation there are 4*4*4 choices of suit.}\\
            &\text{Besides there are 13*12 choices of value for a pair.}\\
            &\text{in this situation there are 4*4*3 choices of suit.}\\
